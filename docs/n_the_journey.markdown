...
autonomous system? Tune in next year for future details as the content on this page will be updated when the next team ULL Ragin' Cajun RoboBoat decides to take on this new challenge....
